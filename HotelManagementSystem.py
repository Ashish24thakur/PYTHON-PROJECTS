...
if ch1==1:
    ...
    if ps in pas and mb in mob:
        ...
        while (j==0):
            ...
            print("\n---------------------------------------------------------------------\n")
            if ch2==1:
                print("\t1)Do you want to order food \n\t2) Do you want to see order details")
                ch3 = int(input())
                print("\n------------------------------------------------------------------\n")
                if ch3==1:
                    i=0
                    ...
                    sum =0 
                    while(i==0):
                        print("\tPlease choose the food you want to order \n\t1) Potatoes\n\t2) Sandwich \n\t3) Burger \n\t4) Noodles")
                        print("\t5) Chilli \n\t6) Rice \n\t7) Pasta \n\t8) Pizza")
                        chf = int(input())
                        print("\n--------------------------------------------------------------\n")
                        if chf==1:
                            ...
                            print("\tWhich item do you want to order??")
                            chf1 = int(input()) 
                            print("\n-----------------------------------------------------------\n")
                            if chf1==1:
                                r = "\ttFrench fries   ---> 70" 
                            ...
                            if chf1==1:
                                r = "\t\tVeg Sandwich   ---> 40" 
                                order.append(r)
                                print("\t\tYour Veg Sandwich is ordered succesfully")
                                sum = sum + 40
                                print("\tDo you need anything else. \n\t1) YES \n\t2) NO")
                                chf11 = int(input()) 
                                if chf11==1:
                            ...
                            if chf1==1:
                                ...
                                sum = sum + 120
                                print("\tYDo you need anything else . \n1) YES \n2) NO")
                                chf11 = int(input()) 
                                if chf11==1:
                                    i=0 
                                elif chf11==2:
                            ...
                            if chf1==1:
                                ...
                                if chf11==1:
                                    ...
                                    print("\tInvalid choice") 
                    print("\n----------------------------------\n")
                    print("\t\tDo You Want to return to Home Page. \n\t\t1) yes \n\t\t2) No")
                    chm = int(input())
                    print("\n----------------------------------\n")
                    if chm==1:
                        j=0  
                    ...
                    print("----------------------------------\n")
                    print("\t1) You want to go back to Home Page \n\t2) You want to exit this service")
                    ch211=int(input())  
                    print("\n----------------------------------\n")
                    if ch211==1:
                        j=0  
